...
plt.plot(XS,YS, 'o', color='#FFD700',markersize=5, label="Soleil")
plt.plot(XV,YV, 'o', color="#B8860B", markersize=2, label="Venus")
plt.plot(XT,YT, 'o', color='#7BC8F6', markersize=2, label="Terre")
plt.plot(XM,YM,'o', color='#FC5A50', markersize=1.5, label="Mars")
plt.plot(XJ,YJ, 'o', color="navajowhite", markersize=2, label="Jupiter")
plt.plot(XSA,YSA, 'o', color="lightsalmon", markersize=2, label="Saturne")
plt.plot(XU,YU,'o', color='paleturquoise', markersize=2.5, label="Uranus")
plt.plot(XN,YN, 'o', color='mediumblue', markersize=7, label="Neptune")

# Limites systeme
#ax.set_xlim(-5*1e12, 5*1e12)
#ax.set_ylim(-5*1e12, 5*1e12)

# Zoom Tellurique
#ax.set_xlim(0*1e12, 0.24*1e12)
#ax.set_ylim(0*1e12, 0.24*1e12)

# Zoom Tellurique + Jupiter + Saturne
#ax.set_xlim(0*1e12, 1.5*1e12)
#ax.set_ylim(0*1e12, 1.5*1e12)

# Zoom Uranus
#ax.set_xlim(1*1e12, 3*1e12)
#ax.set_ylim(1*1e12, 3*1e12)

# Zoom Neptune
#ax.set_xlim(2.75*1e12, 3.5*1e12)
#ax.set_ylim(-3.5*1e12, -2.75*1e12)
